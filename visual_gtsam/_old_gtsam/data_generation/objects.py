...
class SimulationData(object):
    """
    Contains all data necessary to solutions the robot state estimation simulation.
    """
    ...
    def __init__(self, num_steps, filter_data, debug_data):
        ...
        :param num_steps: A scalar value representing the number of steps to solutions the estimation filter for.
